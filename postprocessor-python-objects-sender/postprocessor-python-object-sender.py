...
CONFIG_FILE = os.path.join(script_location, "..", "etc", "plugin.osender.ini")
...
Postprocessor_Name = "Python-Object-Sender-Postprocessor"

# The socket this postprocessor will listen on.
# This is always given as the first argument when the process is started
# But it can be manually defined as well, as long as it is the same as the socket path in the runtime settings
Postprocessor_Socket_Path = "/tmp/python-object-sender-postprocessor.sock"
...
def main():
  ...
  while True:
    ...
    for i in range(0, 10):
      ...
      if key_string not in input_object["ExternalProcessorSettings"]:
        continue
